...
//                        ModBlocks.NEITHER_PORTAL.get()).build(null));
//        ALTAR = Registry.register(Registries.BLOCK_ENTITY_TYPE,
//                InfinityMod.getId("altar_block_entity"),
//                BlockEntityType.Builder.create(TransfiniteAltarEntity::new, ModBlocks.ALTAR_LIT.get()).build(null));
//        ALTAR_COSMIC = Registry.register(Registries.BLOCK_ENTITY_TYPE,
//                InfinityMod.getId("cosmic_block_entity"),
//                BlockEntityType.Builder.create(CosmicAltarEntity::new, ModBlocks.ALTAR_COSMIC.get()).build(null));
    }
}