...
public class IridesenceCraftingEmiRecipe extends BasicEmiRecipe {
    ...
    public IridesenceCraftingEmiRecipe(CollisionCraftingRecipe recipe, DynamicRegistryManager registryManager) {
        super(EmiCompat.IRIDESENCE_CRAFTING, recipe.getId(), 118, 18);
