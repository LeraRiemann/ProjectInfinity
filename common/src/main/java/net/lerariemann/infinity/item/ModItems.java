...
public class ModItems {
    ...
    public static RegistrySupplier<Item> registerKeyItem() {
        Item.Settings keySettings = new Item.Settings().registryKey(registryKey("transfinite_key")).component(ModComponentTypes.KEY_DESTINATION.get(), Identifier.of("minecraft:random"));
        if (PlatformMethods.isFabricApiLoaded("fabric-item-group-api-v1")) {
