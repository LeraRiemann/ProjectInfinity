...
## MISSINGNO
![A dimension composed of endless sepia hallways, illuminated by yellow lights in the ceiling.](https://raw.githubusercontent.com/LeraRiemann/ProjectInfinity/refs/heads/master/assets/backrooms.avif)
- Key: [missingno/no key provided]

When an empty book is given to an Infinity Portal, it creates a missing dimension. Featureless and completely barren, the tunnels of this empty world go on for eternity. Be careful not to get lost.
...
## Colors
![An aerial view of a dimension composed of brightly colored wool and concrete, as well as lakes of a vibrant colored iridescent fluid.](https://raw.githubusercontent.com/LeraRiemann/ProjectInfinity/refs/heads/master/assets/colors.avif)
- Key: colors

A bright dimension with a sky shifting through hues, full of colourful blocks. The liquid that makes up the lakes, known as iridescence, causes a strange reaction when touched.
