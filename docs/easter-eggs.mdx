...
The lovely world of the Hills is a peaceful one, reminiscent of the Overworld but for its namesake hills that make up a large portion of this dimension. As each hill is bordered by a large lake, each individual hill seems taller than they would otherwise.
