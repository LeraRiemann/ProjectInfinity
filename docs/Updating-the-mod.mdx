...
## My world won't load!
If your world won't load even after deleting your `config/infinity` files, or if you are updating from a dramatically different version like 1.20, you may need to manually clear out the old datapack files. With Minecraft open, select your world and choose Edit. Click "Open World Folder", and delete the `datapacks` folder. You should now be able to load into the world. If this does not work, please report it to the issue tracker.
