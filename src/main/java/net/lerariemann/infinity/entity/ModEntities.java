...
public class ModEntities {
    ...
    public static final EntityType<DimensionalSlime> CHAOS_SLIME = register("dimensional_slime",
            EntityType.Builder.create(DimensionalSlime::new, SpawnGroup.MONSTER)
                    .dimensions(0.52f, 0.52f).maxTrackingRange(10));
    public static final EntityType<DimensionalSkeleton> CHAOS_SKELETON = register("dimensional_skeleton",
            EntityType.Builder.create(DimensionalSkeleton::new, SpawnGroup.MONSTER)
                    .dimensions(0.6f, 1.99f).maxTrackingRange(8));
    public static final EntityType<DimensionalCreeper> CHAOS_CREEPER = register("dimensional_creeper",
    ...
    public static void registerEntities() {
        FabricDefaultAttributeRegistry.register(CHAOS_SLIME, DimensionalSlime.createAttributes());
        FabricDefaultAttributeRegistry.register(CHAOS_SKELETON, AbstractSkeletonEntity.createAbstractSkeletonAttributes());
        FabricDefaultAttributeRegistry.register(CHAOS_CREEPER, CreeperEntity.createCreeperAttributes());
    ...
    public static void registerSpawnRestrictions() {
        SpawnRestriction.register(CHAOS_SLIME, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, DimensionalSlime::canSpawn);
        SpawnRestriction.register(CHAOS_SKELETON, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ModEntities::canSpawnInDark);
        SpawnRestriction.register(CHAOS_CREEPER, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ModEntities::canSpawnInDark);
    ...
    public static void registerEntityRenderers() {
        EntityRendererRegistry.register(CHAOS_SLIME, DimensionalSlimeRenderer::new);
        EntityRendererRegistry.register(CHAOS_SKELETON, DimensionalSkeletonRenderer::new);
        EntityRendererRegistry.register(CHAOS_CREEPER, DimensionalCreeperRenderer::new);
